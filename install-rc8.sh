...
echo "[3/7] upstream Plugin Marketplace at pinned revision"
...
echo "[6/7] install usage statistics plugin"
...
echo "Installed the pinned RC.8 plugin set. Restart DSH and verify its logs."
echo "The optional dsh-agent-orchestrator submodule was not installed."
